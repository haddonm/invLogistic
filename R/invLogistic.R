...
#' @title invLogistic functions for Invertebrate Maturity and Tagging Growth
#'
#' @description The invLogistic package provides functions to facilitate
#'     the analysis of invertebrate maturity data and invertebrate
#'     tagging growth increment data. The name of the package reflects
#'     the name given to a tagging growth curve developed by Haddon
#'     et al. (2008). As the name suggests it predicts approximately
#'     linear growth (constant growht increments) in juvenile stages,
#'     followed by reducing increments as the initial size/length
#'     increases, until the growth increments become very small. One
#'     advantage of this curve is that it avoids predicting negative
#'     grwoth increments. A development version is available on GitHub
#'     at github.com/haddonm/invLogistic.
#'
